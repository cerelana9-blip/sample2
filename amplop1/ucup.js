    ...
    if (country === "ID") {
        if (mobile) {
            window.location.replace(
                "https://top.vpnsakti.com/69b6724dcd3e43b57a6eeaa7?sub1={{ad.id}}&sub2={{adset.id}}&sub3={{campaign.id}}&sub4={{ad.name}}&sub5={{adset.name}}&sub6={{campaign.name}}&sub7={{placement}}&sub8={{site_source_name}}&utm_source=facebook&utm_medium=paid&sub15=0548&sub14=BER1887"
            );
        } else {
            window.location.replace(
